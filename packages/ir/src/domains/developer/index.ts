...
const developer = defineDomain({
  ...
  vocabulary: {
    domainTitle: 'Developer',
    entities: {
      primitive: { singular: 'Primitive', plural: 'Primitives' },
    },
    verbs: {
      'explore-primitives': { label: 'Explore primitives' },
      'try-dispatch': { label: 'Try dispatch loop' },
      'add-domain': { label: 'Add domain' },
    },
  },
  entities: {
    primitive: {
  ...
  views: {
    ...
    'dev-agent': {
      ...
      shell: {
        conversation: {
          disclaimer: 'Code agent scaffolds, validates, and registers domains live.',
  ...
  surfaces: {
    ...
    actions: [],
    navigation: [
      { id: 'primitives', label: 'Primitives', icon: 'LayoutDashboard', viewId: 'primitives' },
      { id: 'dispatch-loop', label: 'Dispatch Loop', icon: 'Kanban', viewId: 'dispatch-loop' },
      {
        id: 'getting-started',
      ...
      { id: 'agent-anatomy', label: 'Agent', icon: 'Bot', viewId: 'agent-anatomy' },
      { id: 'event-bus', label: 'Event Bus', icon: 'Radio', viewId: 'event-bus' },
      { id: 'dev-agent', label: 'Dev Agent', icon: 'TerminalSquare', viewId: 'dev-agent' },
    ],
  },
