...
const admin = defineDomain({
    ...
    spaces: {
      ...
      shell: {
        ...
        localAssistant: {
          ...
          capabilities:
            'I can help you switch between role spaces and explain what each space unlocks in the shell.',
        },
      },
    },
    'role-manager': {
  ...
  surfaces: {
    ...
    actions: [],
    navigation: [
      { id: 'spaces', label: 'Spaces', icon: 'Layers', viewId: 'spaces' },
