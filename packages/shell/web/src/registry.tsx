...
import { resolveEntityTypeFromView } from '@worken/shell-web/runtime/domain/catalog'
import { useWorkenMockRuntime } from '@worken/demo/mock-os-runtime'
...
import {
  ...
  openShellInspector,
  selectShellEntities,
} from '@worken/shell-web/session/dispatch'
