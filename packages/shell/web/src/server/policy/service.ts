import { toPermissionSnapshot } from '@worken/shell-web/permissions/shared'
import { DEFAULT_ACTIVE_ROLE_ID, type RoleDefinition } from '@worken/shell-web/permissions/types'
import {
  readPolicyStore,
  resetPolicyStore,
  writePolicyStore,
