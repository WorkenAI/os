...
const hr = defineDomain({
  ...
  vocabulary: {
    ...
    entities: {
      ...
      vacancy: { singular: 'Job opening', plural: 'Job openings' },
      interview: { singular: 'Interview', plural: 'Interviews' },
    },
    verbs: {
      create: { label: 'Create' },
      source: { label: 'Sourcing' },
  ...
  verbs: {
    create: { id: 'create', label: 'Create', scope: 'entity', entityIds: ['candidate', 'vacancy'] },
  ...
  surfaces: {
    ...
    navigation: [
      ...
      { id: 'candidates', label: 'Candidates', icon: 'Users', viewId: 'candidates-table' },
      { id: 'pipeline', label: 'Pipeline', icon: 'Kanban', viewId: 'pipeline-board' },
      { id: 'interviews', label: 'Interviews', icon: 'Calendar', viewId: 'interviews' },
