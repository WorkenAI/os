...
const WORKSPACES: Record<WorkspaceId, WorkspaceDefinition> = {
  docs: {
    ...
    targets: [
      'examples/demo/domains/',
      'apps/web-shell/src/shell/runtime/',
      'apps/web-shell/src/shell/layout/',
    ],
  ...
  runtime: {
    ...
    docs: [
      'examples/demo/domains/manifest.ts',
      'examples/demo/domains/registry.ts',
      'apps/web-shell/src/shell/runtime/screen/shell-screen.tsx',
    ],
    targets: [
      'DomainDefinition',
      'ShellFrame slots',
