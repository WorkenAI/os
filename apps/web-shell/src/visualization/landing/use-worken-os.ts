...
/** @deprecated Use `UseOSOptions`. */
export type UseWorkenOSOptions = UseOSOptions
...
export function useOS({ fallbackDomain, visibleDomains, onShellFocus }: UseOSOptions) {
...
/** @deprecated Use `useOS`. */
export const useWorkenOS = useOS
