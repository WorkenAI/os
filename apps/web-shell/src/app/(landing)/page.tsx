...
import { useOS } from '@/visualization/landing/use-worken-os'
import { getLandingShellPreviewStyle } from '@/visualization/landing/window-settings'
import { getLandingDomainDescriptors } from '@/shell/landing-descriptors'

const LANDING_DOMAINS = getLandingDomainDescriptors()
...
function HomeContent() {
  ...
  const { activeDomain, selectDomain, shell, motion, dock } = useOS({
    fallbackDomain,
